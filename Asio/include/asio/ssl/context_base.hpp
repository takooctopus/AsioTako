...
{
public:
  /// Different methods supported by a context. 【不同的上下文】
  enum method
  {
    /// Generic SSL version 2. 【1995年发布。2011年弃用。存在已知的安全问题。】
    sslv2,
    ...
    /// Generic SSL version 3. 【1996年发布。2015年弃用。存在已知的安全问题。】
    sslv3,
    ...
    /// Generic TLS version 1.【 1999年作为SSL 3.0的升级发布。计划在2020年弃用。】
    tlsv1,
    ...
    /// Generic TLS version 1.1.【2006年发布。计划在2020年弃用。】
    tlsv11,
    ...
    /// Generic TLS version 1.2. 【2008年发布。】【大部分浏览器都支持1.2】
    tlsv12,
    ...
    /// Generic TLS version 1.3.【2018年发布。】
    tlsv13,
  ...
  ASIO_STATIC_CONSTANT(long, no_sslv2 = SSL_OP_NO_SSLv2);   //不使用SSLV2
