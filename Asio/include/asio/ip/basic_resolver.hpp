...
#include "asio/detail/non_const_lvalue.hpp" //不是很明白的type_trait
#include "asio/detail/string_view.hpp"  //可能会有的string_view
#include "asio/detail/throw_error.hpp"  //有异常时抛异常
#include "asio/error.hpp"   //异常代码定义
#include "asio/execution_context.hpp" //执行上下文
#include "asio/ip/basic_resolver_iterator.hpp"  //解析基本迭代器类
#include "asio/ip/basic_resolver_query.hpp" //解析查询类
#include "asio/ip/basic_resolver_results.hpp" //继承于basic_resolver_iterator的解析结果类
#include "asio/ip/resolver_base.hpp"  //基本解析类定义了几个【addrinfo结构体ai_flags的取值】
