...
typedef asio::ip::detail::socket_option::multicast_request<
  ...
  ASIO_OS_DEF(IPV6_JOIN_GROUP)> join_group;	//【加入多播组选项】
#endif
...
typedef asio::ip::detail::socket_option::multicast_request<
  ...
  ASIO_OS_DEF(IPPROTO_IPV6),
  ASIO_OS_DEF(IPV6_LEAVE_GROUP)> leave_group; //【退出用户组】
#endif
...
typedef asio::ip::detail::socket_option::network_interface<
  ...
  ASIO_OS_DEF(IPPROTO_IPV6),
  ASIO_OS_DEF(IPV6_MULTICAST_IF)> outbound_interface; //【绑定外出接口】
#endif
...
typedef asio::ip::detail::socket_option::multicast_hops<
  ...
  ASIO_OS_DEF(IPPROTO_IPV6),
  ASIO_OS_DEF(IPV6_MULTICAST_HOPS)> hops; //【指定外出TTL】
#endif
...
typedef asio::ip::detail::socket_option::multicast_enable_loopback<
  ...
  ASIO_OS_DEF(IPPROTO_IPV6),
  ASIO_OS_DEF(IPV6_MULTICAST_LOOP)> enable_loopback; //【允许回馈】
#endif
