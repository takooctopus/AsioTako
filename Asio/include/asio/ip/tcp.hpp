...
#if defined(_MSC_VER) && (_MSC_VER >= 1200) //只有在MSVC++98后版本可用
# pragma once
...
#include "asio/detail/socket_option.hpp" //socket操作方法
#include "asio/detail/socket_types.hpp" //socket常用常量
#include "asio/ip/basic_endpoint.hpp"   //基本端点
